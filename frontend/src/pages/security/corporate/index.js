            ...
            <dev className="blocks">
                ...
                <dev className="selections">
                    ...
                    <dev className="selection">
                        <p><FuncButton bhref="/security/corporate/open" bicon={<AiOutlinePlus/>} btext="法人开户" /></p>
                        {/* 法人开设证券账户 */}
                    </dev>
                    <dev>
                        <p></p>
                    ...
                    <dev className="selection">
                        <p><FuncButton bhref="/security/corporate/makeup" bicon={<AiOutlineQuestion/>} btext="挂失补办" /></p>
                        {/* 挂失并补办证券账户 */}
                    </dev>
                    <dev>
                        <p></p>
                    ...
                    <dev className="selection">
                    <p><FuncButton bhref="/security/corporate/cancel" bicon={<AiOutlineExclamation/>} btext="账户销户" /></p>
                        {/* 证券账户销户 */}
                    </dev>
                    <dev>
                        <p></p>
