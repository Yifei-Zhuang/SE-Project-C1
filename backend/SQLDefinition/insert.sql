...
-- 个人证券
insert into personSecurity(securityid,name,gender,identityid,homeaddress,work,education,workaddress,phone,agentidentityid,accountstate)
...
-- 个人资金
insert into capitalaccount values(1000,'12345678901234567X',1000000,1000,1234,1234,0,'normal',0);

-- 法人资金账户
insert into capitalaccount values(2000,'000000000000000000',2000000,100000,1234,1234,0,'normal',0);
